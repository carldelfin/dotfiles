...
hi pandocAtxStart gui=bold guibg=#232323 guifg=#6da280 cterm=bold ctermbg=0 ctermfg=6
hi String guifg=#6da280 ctermfg=6

hi Label guifg=#AF7BA9 ctermfg=5
hi pandocCiteLocator guifg=#AF7BA9 ctermfg=5
hi pandocCiteAnchor guifg=#AF7BA9 ctermfg=5
