...
// `-------+-------+-------+-------+-------|    |-------+-------+-------+-------+-------'
                            NUM_TAB,WFL_SPC,     NAV_ENT,FUN_BSP
//                         `-------+-------'    `-------+-------'
    ),
...
// --------
    ...
    [_WFL] = LAYOUT(
// ,-------+-------+-------+-------+-------.    ,-------+-------+-------+-------+-------.
    xxxxxxx,   WS_4,   WS_5,   WS_6,xxxxxxx,      R_TRUE,  R_LIB, R_INST,  R_GHI,xxxxxxx,
// |-------+-------+-------+-------+-------|    |-------+-------+-------+-------+-------|
    xxxxxxx,   WS_1,   WS_2,   WS_3,xxxxxxx,      R_HERE,  R_FIL,  R_MUT,  R_SEL,xxxxxxx,
// |-------+-------+-------+-------+-------.    ,-------+-------+-------+-------+-------|
    xxxxxxx,   WS_7,   WS_8,   WS_9,xxxxxxx,     R_FALSE,  R_FUN,   R_DF,  R_GGP,xxxxxxx,
// `-------+-------+-------+-------+-------|    |-------+-------+-------+-------+-------'
...
// ----------
    ...
    [_NAV] = LAYOUT(
// ,-------+-------+-------+-------+-------.    ,-------+-------+-------+-------+-------.
    xxxxxxx,xxxxxxx,xxxxxxx,xxxxxxx,xxxxxxx,     xxxxxxx, VIM_CD, VIM_CU,xxxxxxx,xxxxxxx,
// |-------+-------+-------+-------+-------|    |-------+-------+-------+-------+-------|
...
// ------------------
    ...
    [_FUN] = LAYOUT(
// ,-------+-------+-------+-------+-------.    ,-------+-------+-------+-------+-------.
      KC_F1,  KC_F2,  KC_F3,  KC_F4,xxxxxxx,     xxxxxxx, FN_CPY, FN_PST,   PM_1,xxxxxxx,
// |-------+-------+-------+-------+-------|    |-------+-------+-------+-------+-------|
