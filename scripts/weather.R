# ==============================================================================
#
# This R script fetches GPS coordinates of a given location using geocode.xyz
# and then reports the weather using data from Meteorologisk institutt in Norway
# (https://api.met.no/). Note that the R package jsonlite is required!
#
# For ease of use, bind it to an alias in your .bashrc, for instance 
# `alias weather='Rscript ~/dotfiles/scripts/weather.R'`
# then call it using `weather City` (e.g., `weather Stockholm`)
# 
# ==============================================================================
